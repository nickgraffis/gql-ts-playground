...
export const GetBranchesByLocationDocument = gql`
    query getBranchesByLocation($coords: [Float], $filters: MarketInsightsFilters, $page: Page) {
  getBranchesByLocation(coords: $coords, filters: $filters, page: $page) {
    id
  }
}
    `;
  ...
  export class GetBranchesByLocationGQL extends Apollo.Query<GetBranchesByLocationQuery, GetBranchesByLocationQueryVariables> {
    document = GetBranchesByLocationDocument;
...
export const AddCompanyDocument = gql`
  ...
  export class AddCompanyGQL extends Apollo.Mutation<AddCompanyMutation, AddCompanyMutationVariables> {
    document = AddCompanyDocument;
...
class Test {
  constructor(public tester: AddCompanyGQL) {
